...
function NavMenuLink({
  ...
  const link = (
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          'nav-menu-link nav-menu-link--sidebar relative z-[1] flex h-10 items-center rounded-lg font-medium transition-[color,transform] text-[length:var(--app-nav-link-size)] focus-app-ring focus-visible:outline-none',
