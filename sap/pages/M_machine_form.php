...
$filed[1] = "idmachine"; // id คีย์หลัก
$filed[2] = "machine,Machine List,,R"; // id คีย์หลัก
$filed[3] = "idzone,Zone,FK:tbzone:zone,R";
$filed[4] = "idwkctrtype,Type,FK:tbwkctrtype:wkctrtype";
//*******   กำหนดค่าแสดงในฟอร์ม  $filed[?] = "Field,Label,ชนิด D=วันที่  หรือ FK=FOREIGN KEY:tb:Field return ,R=required,H=hidden,IC=include File:Filename";   */
