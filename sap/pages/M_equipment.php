...
$myfile = "M_equipment";
$fileload = "Equipment.xlsx";
$lim = "1000"; // จำนวนข้อมูลที่แสดง

$filed1 = "equipment"; // id คีย์หลัก
$filed2 = "equdescrip";
$filed3 = "equipmentsub";
$filed4 = "functionalloc";
$filed5 = "equl";
$filed6 = "equ1";
$filed7 = "equea";
...
if (isset($_POST["import"])){    
  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType)){ //เช็คว่าใช่ไฟล์ excel หรือไม่
        ...
        if($num == 0){ //Check workorder ซ้ำ
            $strSQL = "";
            $strSQL = "INSERT $tbl_policy ($filed1,$filed2,$filed3,$filed4,$filed5,$filed6,$filed7) ";
            $strSQL .= " VALUES (\"$Row[0]\", \"$Row[1]\", \"$Row[2]\", \"$Row[3]\", \"$Row[4]\", \"$Row[5]\", \"$Row[6]\" )";            
          ...
          $sqlupdate_main .= "  $filed1= \"$Row[0]\", $filed2= \"$Row[1]\",$filed3=  \"$Row[2]\",$filed4=\"$Row[3]\",$filed5=\"$Row[4]\",$filed6=\"$Row[5]\",$filed7=\"$Row[6]\" ";
...
if ($_REQUEST['op'] == "save") {
    ...
    // echo $sql;  
     ...
     if ($result_chk->num_rows > 0) {
          //Update  ตารางหลัก
          $sqlupdate_main = "UPDATE $tbl_policy SET ";
          $sqlupdate_main .= " $filed1= \"$_REQUEST[$filed1]\",  $filed2= \"$_REQUEST[$filed2]\", $filed3= \"$_REQUEST[$filed3]\",$filed4=  \"$_REQUEST[$filed4]\",$filed5=  \"$_REQUEST[$filed5]\",$filed6=  \"$_REQUEST[$filed6]\",$filed7=  \"$_REQUEST[$filed7]\" ";
		 ...
		 // echo $sqlupdate_main;
          ...
          $strSQL = "INSERT $tbl_policy ($filed1,$filed2,$filed3,$filed4,$filed5,$filed6,$filed7) ";
            $strSQL .= " VALUES (\"$_REQUEST[$filed1]\",\"$_REQUEST[$filed2]\", \"$_REQUEST[$filed3]\", \"$_REQUEST[$filed4]\", \"$_REQUEST[$filed5]\", \"$_REQUEST[$filed6]\", \"$_REQUEST[$filed7]\" )";            
