...
/*
if (preg_match( "/tb_mntplan.php/i",$_SERVER['PHP_SELF'])) {
    header("Location: ../");
    die();
}
*/

//$title_page = tb_mntplan;
...
if ($_REQUEST['op'] == "save") {
     ...
     if ($result_chk->num_rows > 0) {
          ...
          $sqlupdate_main .= " $filed2='" . $_REQUEST[$filed2] . "',$filed3='" . $_REQUEST[$filed3] . "',$filed4='" . $_REQUEST[$filed4] . "',$filed5='" . $_REQUEST[$filed5] . "' ";
          ...
          $sqlinsert_main = "INSERT $tbl_policy ($filed2,$filed3,$filed4,$filed5) VALUES ('" . $_REQUEST[$filed2] . "','" . $_REQUEST[$filed3] . "','" . $_REQUEST[$filed4] . "','" . $_REQUEST[$filed5] . "')";
