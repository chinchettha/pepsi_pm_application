...
<div class="content-page">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">สมาชิก</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					<!-- <tr role="row" class="odd">
                        ...
                        {
                            $date = date($result['last_login']);
                            $eng_date=strtotime("$date");
                            ?>
                           
                            <tr role="row" class="odd">
                                <td align="center" class="sorting_1"><?php echo $count++;?></td>
                                <td><a href="pages/member_edit.php?memid=<?php echo $result['id'];?>" data-id="<?php echo $result['mem_id'];?>" data-toggle="modal" data-target="#ajaxLargeModal" class="btn-edit"><?php echo $result['fullname']; ?></a></td>
                                <td><?php echo $result['username']; ?></td>
                                <td><?php echo $result['password']; ?></td>
                                <td align="center">
                                    <?php
                                    if($result['last_login']==''){ ?>
                                        <span>ไม่มีความเคลื่อนไหว</span>
                                    <?php }else{ ?>
                                        <span><?php echo thai_date($eng_date);?> </span>
                                    <?php }?>
                                </td>
                                <td align="center">
