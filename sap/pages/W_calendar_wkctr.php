...
$sql = "select `tbiw37n`.`idiw37` AS `idiw37`,`tbiw37n`.`mntplan` AS `mntplan`,`tbiw37n`.`wkorder` AS `wkorder`,`tbiw37n`.`wktype` AS `wktype`,`tbiw37n`.`mat` AS `mat`,`tbiw37n`.`bscstart` AS `bscstart`,`tbiw37n`.`actfinish` AS `actfinish`,`tbiw37n`.`systemstatus` AS `systemstatus`,`tbiw37n`.`opac` AS `opac`,`tbiw37n`.`operationshorttext` AS `operationshorttext`,`tbiw37n`.`ostdescription` AS `ostdescription`,`tbiw37n`.`cknow` AS `cknow`,`tbiw37n`.`wkctr` AS `wkctr`,`tbiw37n`.`work` AS `work`,`tbiw37n`.`actwork` AS `actwork`,`tbiw37n`.`untime` AS `untime`,`tbiw37n`.`equipment` AS `equipment`,`tbiw37n`.`equdescrip` AS `equdescrip`,`tbiw37n`.`functionalloc` AS `functionalloc`,`tbiw37n`.`funcdescrip` AS `funcdescrip`,`tbcofirm`.`idclose` AS `idclose`,`tbcofirm`.`confirmation` AS `confirmation`,`tbcofirm`.`wkctr` AS `wkctrcon`,`tbcofirm`.`stdate` AS `stdate`,`tbcofirm`.`endate` AS `endate`,`tbcofirm`.`timeclose` AS `timeclose`,`tbworkcenter`.`titlewkctr` AS `titlewkctr`,`tbworkcenter`.`namewkctr` AS `namewkctr`,`tbworkcenter`.`surnamewkctr` AS `surnamewkctr`,`tbworkcenter`.`titlewkctreng` AS `titlewkctreng`,`tbworkcenter`.`namewkctreng` AS `namewkctreng`,`tbworkcenter`.`surnamewkctreng` AS `surnamewkctreng`,`tbworkcenter`.`startwork` AS `startwork`,`tbworkcenter`.`idposition` AS `idposition`,`tbworkcenter`.`wkctr` AS `wkctrwork`,`tbworkcenter`.`plnt` AS `plnt`,`tbworkcenter`.`cat` AS `cat`,`tbworkcenter`.`resp` AS `resp`,`tbworkcenter`.`idwkctrgroup` AS `idwkctrgroup`,`tbworkcenter`.`idwkctrtype` AS `idwkctrtype`,`tbworkcenter`.`wkctrdate` AS `wkctrdate`,`tbworkcenter`.`wkctrtel` AS `wkctrtel`,`tbworkcenter`.`wkctrmail` AS `wkctrmail`,`tbworkcenter`.`labourcost` AS `labourcost`,`tbworkcenter`.`userst` AS `UserST`,`tbworkcenter`.`pass` AS `Password`,`tbworkcenter`.`workstatus` AS `workstatus`,`tbwkstatus`.`idwkstatus` AS `idwkstatus`,`tbwkstatus`.`syst` AS `syst`,`tbmoveplan`.`idmplan` AS `idmplan`,`tbmoveplan`.`cday` AS `cday`,`tbmoveplan`.`mday` AS `mday`,`tbmoveplan`.`mwkctr` AS `mwkctr`,`tbmoveplan`.`reasoncode` AS `reasoncode`,`tbreason`.`reasonname` AS `reasonname`,`tbmoveplan`.`resoncom` AS `resoncom`,`tbmoveplan`.`mpcount` AS `mpcount`,`tbworkcenter`.`iddepartment` AS `iddepartment`,`tbcofirm`.`cwkctr` AS `cwkctr`,`tbwkstatus`.`wkstcolor` AS `wkstcolor` from (((((`tbiw37n` left join `tbcofirm` on((`tbiw37n`.`idiw37` = `tbcofirm`.`idiw37`))) left join `tbworkcenter` on((`tbcofirm`.`cwkctr` = `tbworkcenter`.`idwkctr`))) left join `tbwkstatus` on((`tbiw37n`.`syst` = `tbwkstatus`.`syst`))) left join `tbmoveplan` on((`tbiw37n`.`idiw37` = `tbmoveplan`.`idiw37`))) left join `tbreason` on((`tbmoveplan`.`reasoncode` = `tbreason`.`reasoncode`))) WHERE wkctr = '".$_SESSION['username']."' ";
//echo $sql;
$req = $bdd->prepare($sql);
$req->execute();
$events = $req->fetchAll();
