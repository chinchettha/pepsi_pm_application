...
$title_page = "ข้อมูลนำเข้า Machine";
$tbl_policy = "tbmainteanance";
$myfile = "M_machine";
$fileload = "Machine.xlsx";

$filed1 = "idmachine"; // id คีย์หลัก
$filed2 = "machine";
$filed3 = "idzone";
$filed4 = "idwkctrtype";
...
if(!empty(trim($Row[1]))){                 
 ...
 //หา ID 
if(!empty(trim($Row[2]))){                 
    $Row[2] =  ShowDetail('tbwkctrtype','wkctrtype',$Row[2],$filed4); // $tb=Table,  $a=Field Where , $b=Value Search , $c=Field Return1 
 }
        
        //ค้นหาเลข workorder และ Opac ว่าซ้ำกันหรือไม่
        $SQLtw = "SELECT * FROM $tbl_policy where $filed2 ='".$Row[0]."' ";
        //echo $SQLtw;
        ...
        if($num == 0){ //Check workorder ซ้ำ
            $strSQL = "";
            $strSQL = "INSERT $tbl_policy ($filed2,$filed3,$filed4) ";
          ...
          $sqlupdate_main .= "  $filed2= \"$Row[0]\", $filed3= \"$Row[1]\", $filed4= \"$Row[2]\" ";
...
if ($_REQUEST['op'] == "save") {
    ...
    if(!empty(trim($_REQUEST[$filed4]))){                 
        $Row[4] =  ShowDetail('tbwkctrtype','wkctrtype',$_REQUEST[$filed4],$filed4); // $tb=Table,  $a=Field Where , $b=Value Search , $c=Field Return1 
    }
    //หา ID 
     ...
     if ($result_chk->num_rows > 0) {
          //Update  ตารางหลัก
          $sqlupdate_main = "UPDATE $tbl_policy SET ";
          $sqlupdate_main .= "  $filed2= \"$_REQUEST[$filed2]\", $filed3= \"$Row[3]\", $filed4= \"$Row[4]\" ";
		 ...
		 // echo $sqlupdate_main;
          ...
          $strSQL = "INSERT $tbl_policy ($filed2,$filed3,$filed4) ";
            $strSQL .= " VALUES (\"$_REQUEST[$filed2]\", \"$Row[3]\", \"$Row[4]\" )";            
...
?>
                                            <tr>
                                                ...
                                                <td><?php echo ShowDetail('tbzone','idzone', $result[$filed3],'zone');?></td>  
                                                <td><?php echo  ShowDetail('tbwkctrtype','idwkctrtype', $result[$filed4],'wkctrtype'); // $tb=Table,  $a=Field Where , $b=Value Search , $c=Field Return1 ?></td>                                          
                                                <td align="center">
