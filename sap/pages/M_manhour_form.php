...
$filed[1] = "idmanhour"; // id คีย์หลัก
$filed[2] = "idwkctr,รหัส";
$filed[3] = "stworkday,Start Date,D";
$filed[4] = "workday,End Date,D";
$filed[5] = "wh,WH";
$filed[6] = "ot1,OT1";
$filed[7] = "ot15,OT5";
$filed[8] = "ot1hol,OT1HOL";
$filed[9] = "ot2,OT2";
$filed[10] = "ot3,OT3";
//*******   กำหนดค่าแสดงในฟอร์ม  $filed[?] = "Field,Label,ชนิด D=วันที่  หรือ FK=FOREIGN KEY:tb:Field return ,R=required,H=hidden,IC=include File:Filename";   */
