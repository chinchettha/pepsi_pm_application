...
$title_page = "ข้อมูลนำเข้า Material";
$tbl_policy = "tbmaterial";
$myfile = "M_material";
$fileload = "Material.xlsx";
$lim = "1000"; // จำนวนข้อมูลที่แสดง

$filed1 = "idmaterial"; // id คีย์หลัก
$filed2 = "wkorder";
$filed3 = "matdoc";
$filed4 = "entrydate";
$filed5 = "matpo";
...
if (isset($_POST["import"])){    
  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType)){ //เช็คว่าใช่ไฟล์ excel หรือไม่
        ...
        // แสดงผลการ  Update ******************  -->    
        if (trim($Row[0]) == "" || trim($Row[4]) == "" || trim($Row[6]) == "" || trim($Row[9]) == "" || trim($Row[11]) == "" ) { //colum ที่ต้องาการเช็คค่าว่าง   
            ?>
            <tr>
        ...
        if(!empty(trim($Row[4]))){
            $day4 = explode(".", $Row[4]);          
            $Row[4] = mktime(0, 0, 0, $day4[1], $day4[0], $day4[2]);  
        } 
        if(!empty(trim($Row[5]))){
            $day5 = explode(".", $Row[5]);          
            $Row[5] = mktime(0, 0, 0, $day5[1], $day5[0], $day5[2]);  
        } 
        //แปลงวันที่
     
        //ค้นหาเลข workorder และ Opac ว่าซ้ำกันหรือไม่
        $SQLtw = "SELECT * FROM $tbl_policy where $filed2 ='".$Row[0]."' and $filed6 ='".$Row[4]."'  and $filed11 = '".$Row[9]."' and $filed13 = '".$Row[11]."'  ";
        //echo $SQLtw;
        ...
        if($num == 0){ //Check workorder ซ้ำ
            ...
            $strSQL .= " VALUES ( '".$Row[0]."', '".$Row[1]."', '".$Row[2]."', '".$Row[3]."' , '".$Row[4]."' , '".$Row[5]."' , '".$Row[6]."' , '".$Row[7]."' , '".$Row[8]."' , '".$Row[9]."' , '".$Row[10]."' , '".$Row[11]."' , '".$Row[12]."' , '' , '".$Row[13]."' , '".$Row[14]."' )";            
          ...
          $sqlupdate_main .= "  $filed3= '".$Row[1]."', $filed4= '".$Row[2]."',$filed6=  '".$Row[4]."',$filed7=  '".$Row[5]."',$filed8=  '".$Row[6]."',$filed9=  '".$Row[7]."',$filed10=  '".$Row[8]."',$filed11=  '".$Row[9]."',$filed12=  '".$Row[10]."' ,$filed13=  '".$Row[11]."',$filed14=  '".$Row[12]."',$filed16=  '".$Row[13]."',$filed17=  '".$Row[14]."'   ";
          $sqlupdate_main .= " where $filed1 ='".$result0["idmaterial"]."'  ";
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0" data-page-length='50'>
                                        ...
                                        <tbody>
<?php
$strSQL = "SELECT * FROM $tbl_policy order by idmaterial  DESC  limit 0,$lim ";
