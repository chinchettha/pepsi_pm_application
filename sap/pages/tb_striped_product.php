...
/*
if (preg_match( "/tb_striped_product.php/i",$_SERVER['PHP_SELF'])) {
    header("Location: ../");
    die();
}
*/
...
$tbl_policy = "tb_striped_product";
$myfile = "tb_striped_product";

$filed1 = "id_striped_pd"; // id คีย์หลัก
$filed2 = "striped_pd_name";
$filed3 = "stpiped_disction";
...
if ($_REQUEST['op'] == "save") {
     ...
     if ($result_chk->num_rows > 0) {
          ...
          $sqlinsert_main = "INSERT $tbl_policy ($filed2,$filed3) VALUES ('" . $_REQUEST[$filed2] . "','" . $_REQUEST[$filed3] . "')";
