...
<div class="content-page">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Work Order Status</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					<!-- <tr role="row" class="odd">
                        ...
                        <?php
                        $strSQL = " SELECT * FROM work_order_status;";
                        ...
                        while($result = mysqli_fetch_array($query))
                        {
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><a href="pages/member_edit.php?memid=<?php echo $result['id'];?>" data-id="<?php echo $result['mem_id'];?>" data-toggle="modal" data-target="#ajaxLargeModal" class="btn-edit"><?php echo $result['Entered by']; ?></a></td>
                                <td><?php echo $result['Description']; ?></td>
                                <td><?php echo $result['System status']; ?></td>
                                <td><?php echo $result['Equipment descriptn']; ?></td>
