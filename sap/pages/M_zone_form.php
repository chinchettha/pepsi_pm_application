...
$filed[1] = "idzone"; // id คีย์หลัก
$filed[2] = "zone,Zone,,R"; // id คีย์หลัก
$filed[3] = "zonedescrip,Description";
$filed[4] = "idproductline,Line Product,FK:tbproductline:productline,R";
//*******   กำหนดค่าแสดงในฟอร์ม  $filed[?] = "Field,Label,ชนิด D=วันที่  หรือ FK=FOREIGN KEY:tb:Field return ,R=required,H=hidden,IC=include File:Filename";   */
