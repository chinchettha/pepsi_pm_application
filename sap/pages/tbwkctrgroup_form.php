...
$title_page = "ข้อมูลกลุ่มงาน";
$tbl_policy = "tbwkctrgroup";
$myfile = "tbwkctrgroup";

$filed1 = "idwkctrgroup"; // id คีย์หลัก
$filed2 = "wkctrgroup";
$filed3 = "wkctrdescription";
		...
		<div class="modal-body">
				...
				<div class="input-group mb-3">
					<div class="input-group-prepend" >
						<span class="btn btn-info" style="width: 180px; text-align: right;"><i class='fa fa-key nav-icon'></i><?php echo $filed1;?> *</span>
					</div>
					<input type="text" class="form-control text-danger bg-light" placeholder="" id="<?php echo $filed1;?>" name="<?php echo $filed1;?>" value="<?php echo $result[$filed1];?>" data-toggle="tooltip" data-html="true" data-placement="top" title="<?php echo $filed1;?>" style="font-weight:bold;" required>
				</div>
				<div class="input-group mb-3">
					<div class="input-group-prepend" >
						<span class="btn btn-info" style="width: 180px; text-align: right;"><?php echo $filed2;?> *</span>
					</div>
					<input type="text" class="form-control" placeholder="" id="<?php echo $filed2;?>" name="<?php echo $filed2;?>" value="<?php echo $result[$filed2];?>" data-toggle="tooltip" data-html="true" data-placement="top" title="<?php echo $filed2;?>" required>
				</div>
				<div class="input-group mb-3">
					<div class="input-group-prepend" >
						<span class="btn btn-info" style="width: 180px; text-align: right;"><?php echo $filed3;?> *</span>
					</div>
					<input type="text" class="form-control" placeholder="" id="<?php echo $filed3;?>" name="<?php echo $filed3;?>" value="<?php echo $result[$filed3];?>" data-toggle="tooltip" data-html="true" data-placement="top" title="<?php echo $filed3;?>" required>
				</div>
