              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
					<!-- <tr role="row" class="odd">
                        ...
                        <?php
                        $strSQL = " SELECT * FROM confirmation;";
                        ...
                        while($result = mysqli_fetch_array($query))
                        {
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><a href="pages/member_edit.php?memid=<?php echo $result['id'];?>" data-id="<?php echo $result['mem_id'];?>" data-toggle="modal" data-target="#ajaxLargeModal" class="btn-edit"><?php echo $result['Confirm']; ?></a></td>
                                <td><?php echo $result['Equipment']; ?></td>
                                <td><?php echo $result['WkCtrAct']; ?></td>
                                <td><?php echo $result['Act. work']; ?></td>
