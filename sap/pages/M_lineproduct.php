...
$title_page = "ข้อมูลนำเข้า Line Product";
$tbl_policy = "tbproductline";
$myfile = "M_lineproduct";
$fileload = "LineProduct.xlsx";

$filed1 = "idproductline"; // id คีย์หลัก
$filed2 = "productline";
$filed3 = "prolinedescrip";
...
if (isset($_POST["import"])){    
  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType)){ //เช็คว่าใช่ไฟล์ excel หรือไม่
        ...
        if($num == 0){ //Check workorder ซ้ำ
            $strSQL = "";
            $strSQL = "INSERT $tbl_policy ($filed2,$filed3) ";
            $strSQL .= " VALUES (\"$Row[0]\", \"$Row[1]\" )";            
          ...
          $sqlupdate_main .= "  $filed2= \"$Row[0]\", $filed3= \"$Row[1]\" ";
    ...
    // echo $sql;  
     ...
     if ($result_chk->num_rows > 0) {
		 ...
		 // echo $sqlupdate_main;
          ...
          $strSQL = "INSERT $tbl_policy ($filed2,$filed3) ";
            $strSQL .= " VALUES (\"$_REQUEST[$filed2]\", \"$_REQUEST[$filed3]\" )";            
