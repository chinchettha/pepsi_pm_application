...
$title_page = "ข้อมูลนำเข้า Zone";
$tbl_policy = "tbzone";
$myfile = "M_zone";
$fileload = "Zone.xlsx";

$filed1 = "idzone"; // id คีย์หลัก
$filed2 = "zone";
$filed3 = "zonedescrip";
$filed4 = "idproductline";
...
//หา ID 
if(!empty(trim($Row[2]))){                 
    $Row[2] =  ShowDetail('tbproductline','productline',$Row[2],$filed4); // $tb=Table,  $a=Field Where , $b=Value Search , $c=Field Return1 
 }
...
if ($_REQUEST['op'] == "save") {
    ...
    if(!empty(trim($_REQUEST[$filed4]))){                 
        $Row[4] =  ShowDetail('tbproductline','productline',$_REQUEST[$filed4],$filed4); // $tb=Table,  $a=Field Where , $b=Value Search , $c=Field Return1 
    }
     ...
     if ($result_chk->num_rows > 0) {
          //Update  ตารางหลัก
          $sqlupdate_main = "UPDATE $tbl_policy SET ";
          $sqlupdate_main .= "  $filed2= \"$_REQUEST[$filed2]\", $filed3= \"$_REQUEST[$filed3]\", $filed4= \"$Row[4]\" ";
		 ...
		 // echo $sqlupdate_main;
          ...
          $strSQL = "INSERT $tbl_policy ($filed2,$filed3,$filed4) ";
            $strSQL .= " VALUES (\"$_REQUEST[$filed2]\", \"$_REQUEST[$filed3]\", \"$Row[4]\" )";            
...
?>
                                            <tr>
                                                ...
                                                <td><?php echo  ShowDetail('tbproductline','idproductline', $result[$filed4],'productline'); // $tb=Table,  $a=Field Where , $b=Value Search , $c=Field Return1 ?></td>                                          
                                                <td align="center">
