...
$title_page = "Config System  Type Status";
...
if ($_REQUEST['op'] == "save") {
    ...
    // echo $sql;  
     ...
     if ($result_chk->num_rows > 0) {
          ...
          $sqlupdate_main .= "  $filed1= \"$_REQUEST[$filed1]\", $filed2= \"$_REQUEST[$filed2]\" ";
		 ...
		 // echo $sqlupdate_main;
          ...
          $strSQL = "INSERT $tbl_policy ($filed1,$filed2) ";
            $strSQL .= " VALUES (\"$_REQUEST[$filed1]\", \"$_REQUEST[$filed2]\" )";            
