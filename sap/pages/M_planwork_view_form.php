...
<div class="container-fluid">
			<ul class="nav nav-tabs border-0" id="myTab" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link border border-danger border-bottom-0" id="Machine-tab" data-toggle="tab" href="#Planning" role="tab" aria-controls="Machine" aria-selected="false">Planning</a>
				</li>
			</ul>
