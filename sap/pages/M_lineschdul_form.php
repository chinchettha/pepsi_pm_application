...
$filed[1] = "idline"; // id คีย์หลัก
$filed[2] = "idproductline,Line,FK:tbproductline:productline,R";
$filed[3] = "lineday,Day,D,R";
$filed[4] = "uptime,UP Time";
$filed[5] = "linereason,Reason";
//*******   กำหนดค่าแสดงในฟอร์ม  $filed[?] = "Field,Label,ชนิด D=วันที่  หรือ FK=FOREIGN KEY:tb:Field return ,R=required,H=hidden,IC=include File:Filename";   */
