...
/*
if (preg_match( "/tb_machine.php/i",$_SERVER['PHP_SELF'])) {
    header("Location: ../");
    die();
}
*/

//$title_page = tb_machine;
$tbl_policy = "tb_mntplan";
$myfile = "tb_mntplan";

$filed1 = "id_mntplan"; // id คีย์หลัก
$filed2 = "mntplan";
$filed3 = "maint_itemtext";
$filed4 = "maintplandscrptn";
$filed5 = "mnt_com";
		...
		<div class="modal-body">
				...
				<div class="form-group">
					<label for="<?php echo $filed5;?>">
						<span class="text-secondary" v-if="item.id == 0"><?php echo $filed5;?> *</span>
						<!-- <span v-else><?php echo $filed5;?></span> -->
					</label>
					<input type="<?php echo $filed5;?>" name="<?php echo $filed5;?>" value="<?php echo $result[$filed5];?>" id="<?php echo $filed5;?>" v-model="item.<?php echo $filed5;?>" class="form-control" autocomplete="off"  />
				</div>
