...
$filed[1] = "idwkctrgroup"; // id คีย์หลัก
//$filed[2] = "idwklevel,Level Code,,R"; // id คีย์หลัก
$filed[2] = "wkctrgroup,Group,,R";
$filed[3] = "wkctrdescription,Group Description";
