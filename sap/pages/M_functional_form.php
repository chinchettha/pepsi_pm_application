...
$filed[1] = "functionalloc"; // id คีย์หลัก
$filed[2] = "functionalloc,Functional loc.,,R"; // id คีย์หลัก
$filed[3] = "funldescrip,Description,,R";
$filed[4] = "functionallocsub,Functional loc. Sub";
//*******   กำหนดค่าแสดงในฟอร์ม  $filed[?] = "Field,Label,ชนิด D=วันที่  หรือ FK=FOREIGN KEY:tb:Field return ,R=required,H=hidden,IC=include File:Filename";   */
