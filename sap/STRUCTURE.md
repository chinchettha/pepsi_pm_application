...
**สำเนาที่รากโปรเจกต์:** [`sap-legacy-STRUCTURE.md`](../sap-legacy-STRUCTURE.md) — แก้เนื้อหาแล้วควรอัปเดตทั้งสองไฟล์ให้ตรงกัน
...
พารามิเตอร์ **`?module=ชื่อไฟล์`** (ไม่มี `.php`) จะ map เป็น **`pages/ชื่อไฟล์.php`**
...
└── STRUCTURE.md              # เอกสารนี้ (+ สำเนาราก: sap-legacy-STRUCTURE.md)
```
...
| `modalPages/` | ~37 |
| `include/` | 7 |
| รวม `vendor/` | จำนวนมาก (third-party; ไม่ต้องทำความเข้าใจทีละไฟล์) |
