...
if(!empty($_POST["Event"])){
    ...
    $stdate = $_POST["Event"][1];
    $stdate = explode(".",$stdate);
    $startdate =  mktime(0,0,0,$stdate[1],$stdate[0],$stdate[2]);
    $ShowTK = $_POST["Event"][2];
?>
...
$sql = " SELECT * FROM $tb  where idiw37='$idiw37' ";
		  ...
		  <div class="modal-dialog modal-lg" role="document">
			...
			<form class="form-horizontal" method="POST" action="calendar/editEventTitle.php">
			  ...
			  <div class="input-group mb-3">  
						  ...
						  <?PHP echo $row["operationshorttext"] ?> &nbsp; <?PHP if(!empty($row["team"])){  echo " <strong  > TEAM ". $row["team"]. "</strong>" ;  }  ?>   </button>
    				</div>
...
<div class="container h-100 py-2">
			<ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                ...
                <!-------สลับการโชว์ Tab--------->
                <li class="nav-item">
					<a class="nav-link <?PHP echo $AcWR;?> border border-primary border-bottom-0" id="WorkOrder-tab" data-toggle="tab" href="#WorkOrder" role="tab" aria-controls="WorkOrder" aria-selected="true">Work Order</a>
				</li>
				<li class="nav-item">
					<a class="nav-link <?PHP echo $AcTL;?>  border border-warning border-bottom-0" id="TaskList-tab" data-toggle="tab" href="#TaskList" role="tab" aria-controls="TaskList" aria-selected="false">Task List</a>
				</li>
				...
				<?PHP 
				if($_SESSION['UserST'] == "A"  ){ //เช็คสิทธิ์การย้าย
				?>
				<li class="nav-item">
					<a class="nav-link border border-success border-bottom-0" id="Planning-tab" data-toggle="tab" href="#Planning" role="tab" aria-controls="Planning" aria-selected="false">Planning</a>
				</li>
				<?PHP  
					} // if($_SESSION['UserST'] == "A" || $_SESSION['UserST'] == "H" || $_SESSION['UserST'] == "W" ){ //เช็คสิทธิ์การย้าย
				?>	
				<li class="nav-item">
					<a class="nav-link border border-info border-bottom-0" id="Material-tab" data-toggle="tab" href="#Material" role="tab" aria-controls="Material" aria-selected="false">Material</a>
				</li>
			</ul>

			<div class="tab-content h-75">
				<div class="tab-pane h-100 p-3 <?PHP echo $AcWR;?>  border border-primary" id="WorkOrder" role="tabpanel" aria-labelledby="WorkOrder-tab">
				<?php
					include("TabWorkOrder.php");
				?>		
				</div>
				<div class="tab-pane h-100 p-3 <?PHP echo $AcTL;?>  border border-warning" id="TaskList" role="tabpanel" aria-labelledby="TaskList-tab">
				<?php
					include("TabTarkList.php");
				?>			
				</div>
										
				<div class="tab-pane h-100 p-3 border border-success" id="Planning" role="tabpanel" aria-labelledby="Planning-tab">
				<?php
                ...
                <div class="tab-pane h-100 p-3 border border-info" id="Material" role="tabpanel" aria-labelledby="Material-tab">
				<?php
					include("TabMaterial.php");
				?>			
				</div>
