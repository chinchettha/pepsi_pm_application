...
// สี ย้ายข้ามเดือน
$sqlMov = "SELECT * FROM  tbwkstatus where syst='MOVE OVER'   ";
$qrMov = mysqli_query($link, $sqlMov) or die ("Error Query [".$sqlMov."]");
$rsMov = mysqli_fetch_array($qrMov);
$GLOBALS["ColorMove"]=$rsMov["wkstcolor"]; // สี ย้ายข้ามเดือน

$Factory_code = "7151";  // รหัสโรงงาน ลำพูน
